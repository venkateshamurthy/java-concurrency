...
public class FactE2eBktPrptySpcid extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1207805249;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBktPrptySpcid FACT_E2E_BKT_PRPTY_SPCID = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBktPrptySpcid();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.BUCKET</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.SPACE_ID</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.PROPERTY_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID</code> table reference
	 */
	public FactE2eBktPrptySpcid() {
		super("FACT_E2E_BKT_PRPTY_SPCID", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_BKT_PRPTY_SPCID</code> table reference
	 */
	public FactE2eBktPrptySpcid(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBktPrptySpcid.FACT_E2E_BKT_PRPTY_SPCID);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBktPrptySpcid as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBktPrptySpcid(alias);
	}
}
