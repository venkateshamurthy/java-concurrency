...
public class FactE2eBrwsr extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1077497491;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_BRWSR</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBrwsr FACT_E2E_BRWSR = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBrwsr();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.BROWSER_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_BRWSR.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_BRWSR</code> table reference
	 */
	public FactE2eBrwsr() {
		super("FACT_E2E_BRWSR", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_BRWSR</code> table reference
	 */
	public FactE2eBrwsr(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBrwsr.FACT_E2E_BRWSR);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBrwsr as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2eBrwsr(alias);
	}
}
