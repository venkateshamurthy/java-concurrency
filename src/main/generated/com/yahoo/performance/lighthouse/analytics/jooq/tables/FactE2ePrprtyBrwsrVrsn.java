...
public class FactE2ePrprtyBrwsrVrsn extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = -441283621;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyBrwsrVrsn FACT_E2E_PRPRTY_BRWSR_VRSN = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyBrwsrVrsn();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.PROPERTY_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.BROWSER_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.BROWSER_VERSION</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN</code> table reference
	 */
	public FactE2ePrprtyBrwsrVrsn() {
		super("FACT_E2E_PRPRTY_BRWSR_VRSN", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_PRPRTY_BRWSR_VRSN</code> table reference
	 */
	public FactE2ePrprtyBrwsrVrsn(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyBrwsrVrsn.FACT_E2E_PRPRTY_BRWSR_VRSN);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyBrwsrVrsn as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyBrwsrVrsn(alias);
	}
}
