...
public class FactE2ePrprtyDtls extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1012769716;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_PRPRTY_DTLS</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyDtls FACT_E2E_PRPRTY_DTLS = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyDtls();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.PROPERTY_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.AD_START_BEFORE_LOAD</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_AD_INIT_DELAY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.N95TH_PAGE_RENDER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_AD_INIT_DELAY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_DTLS.MEAN_PAGE_RENDER_LATENCY</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_PRPRTY_DTLS</code> table reference
	 */
	public FactE2ePrprtyDtls() {
		super("FACT_E2E_PRPRTY_DTLS", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_PRPRTY_DTLS</code> table reference
	 */
	public FactE2ePrprtyDtls(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyDtls.FACT_E2E_PRPRTY_DTLS);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyDtls as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyDtls(alias);
	}
}
