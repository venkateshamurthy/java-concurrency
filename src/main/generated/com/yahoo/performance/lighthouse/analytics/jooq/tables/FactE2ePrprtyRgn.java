...
public class FactE2ePrprtyRgn extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 334942517;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_PRPRTY_RGN</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgn FACT_E2E_PRPRTY_RGN = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgn();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.PROPERTY_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.REGION</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_PRPRTY_RGN</code> table reference
	 */
	public FactE2ePrprtyRgn() {
		super("FACT_E2E_PRPRTY_RGN", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_PRPRTY_RGN</code> table reference
	 */
	public FactE2ePrprtyRgn(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgn.FACT_E2E_PRPRTY_RGN);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgn as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgn(alias);
	}
}
