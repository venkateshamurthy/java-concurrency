...
public class FactE2ePrprtyRgnDtls extends org.jooq.impl.TableImpl<org.jooq.Record> {

	private static final long serialVersionUID = -760323624;

	/**
	 * The singleton instance of <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS</code>
	 */
	public static final com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgnDtls FACT_E2E_PRPRTY_RGN_DTLS = new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgnDtls();
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.REPORT_DATE</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.PROPERTY_NAME</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.REGION</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.IMPRESSIONS</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.AD_START_BEFORE_LOAD</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_AD_INIT_DELAY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.N95TH_PAGE_RENDER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_E2E</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_TIME_BEFORE_AD_RENDER</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_AD_INIT_DELAY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_SERVER_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_CLIENT_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_FAC_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_POSITION_LATENCY</code>. 
	 */
	...
	/**
	 * The column <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS.MEAN_PAGE_RENDER_LATENCY</code>. 
	 */
	...
	/**
	 * Create a <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS</code> table reference
	 */
	public FactE2ePrprtyRgnDtls() {
		super("FACT_E2E_PRPRTY_RGN_DTLS", com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15);
	}

	/**
	 * Create an aliased <code>K2V15.FACT_E2E_PRPRTY_RGN_DTLS</code> table reference
	 */
	public FactE2ePrprtyRgnDtls(java.lang.String alias) {
		super(alias, com.yahoo.performance.lighthouse.analytics.jooq.K2v15.K2V15, com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgnDtls.FACT_E2E_PRPRTY_RGN_DTLS);
	}
	 ...
	 */
	@Override
	public com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgnDtls as(java.lang.String alias) {
		return new com.yahoo.performance.lighthouse.analytics.jooq.tables.FactE2ePrprtyRgnDtls(alias);
	}
}
